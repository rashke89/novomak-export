...
export const CATEGORY_REVIEW_SAVE_REQUEST = 'CATEGORY_REVIEW_SAVE_REQUEST';
export const CATEGORY_REVIEW_SAVE_SUCCESS = 'CATEGORY_REVIEW_SAVE_SUCCESS';
export const CATEGORY_REVIEW_SAVE_FAIL = 'CATEGORY_REVIEW_SAVE_FAIL';
export const CATEGORY_REVIEW_SAVE_RESET = 'CATEGORY_REVIEW_SAVE_RESET';
